...
def banner():
	...
	sol().print(wel2)
	au='AUTHOR    :  IYAN X LORD\nGITHUB    :  https://github.com/iyanxlord\nWHATSAPP  :  6285881661596'
...
def ceker(idf,pw):
	global cp
	ua1 = 'Mozilla/5.0 (Linux; Android 11; vivo 1901 Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.106 Mobile Safari/537.36 GSA/12.22.8.23.arm64',
    ua2 ='Mozilla/5.0 (Symbian/3; Series60/5.2 NokiaN8-00/012.002; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) NokiaBrowser/7.3.0 Mobile Safari/533.4 3gpp-gba',
